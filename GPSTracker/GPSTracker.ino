...
double gpsmps = 0.0, gpskmph = 0.0, alt = 0.0, gpshdop = 0.0, minpkm = 999.99, bMinpkm = 999.99;
...
void dataLogging(){
  Serial.println("\n\n Data Logging");
  sprintf(fileNameBuffer, "/%02u-%02u-%04uSGPS.csv", month(), day(), year());
  ...
  if (gps.satellites.isValid())
  {
    ...
    Serial.print("Age of Satellite: ");
    Serial.println(ageSat);
  ...
  if (gps.altitude.isValid())
  {
    ...
    Serial.print("Age of Altitude: ");
    Serial.println(ageAlt);
    Serial.print("Current Altitude in meter(s): ");
    Serial.println(alt);
  }
  if (gps.hdop.isValid())
  {
  ...
  if (gps.speed.isUpdated())
  {
    ...
    if (!(gpskmph <= 0.5))
      minpkm = 60.0 / gpskmph;
    Serial.print("Age of Speed: ");
    Serial.println(ageSpd);
    Serial.print("Speed in MPH: ");
    Serial.println(gpsmps);
    Serial.print("Speed in KMPH: ");
    Serial.println(gpskmph);
  }
